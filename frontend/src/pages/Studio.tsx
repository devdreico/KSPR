  ...
  return (
    <div className={`app-shell app-shell-v2 ${sidebarOpen ? "sidebar-is-open" : "sidebar-is-closed"}`}>
      <aside className="session-sidebar">
        <div className="sidebar-brand"><img src="/kspr-favicon.png" alt="KSPR" /><div><strong>KSPR</strong><span>Reverse engineering agent</span></div><button className="sidebar-icon" onClick={() => setSidebarOpen(false)} aria-label="Cerrar barra lateral"><Menu size={16} /></button></div>
        ...
        <div className="workspace-label"><span>WORKSPACE</span><strong>kspr / local</strong></div>
