  ...
  return (
    <div className={`app-shell app-shell-v2 ${sidebarOpen ? "sidebar-is-open" : "sidebar-is-closed"}`}>
      <aside className="session-sidebar">
        <div className="sidebar-brand"><img src="/casper-ai-logo.png" alt="CASPER AI" /><div><strong>CASPER AI</strong><span>Empresarial</span></div><button className="sidebar-icon" onClick={() => setSidebarOpen(false)} aria-label="Cerrar barra lateral"><Menu size={16} /></button></div>
